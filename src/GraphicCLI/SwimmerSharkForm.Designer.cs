namespace GUI
{
    partial class SwimmerSharkForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 22;
            label1.Text = "Выберите игрока, у которого хотите забрать карту";
            ...
            Name = "SwimmerSharkForm";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "SwimmerSharkForm";
            ResumeLayout(false);
        }
